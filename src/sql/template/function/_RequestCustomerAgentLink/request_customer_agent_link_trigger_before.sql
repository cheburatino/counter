-- функция триггер
DROP FUNCTION IF EXISTS request_customer_agent_link_trigger_before() CASCADE;
CREATE OR REPLACE FUNCTION request_customer_agent_link_trigger_before() RETURNS trigger AS
$$
DECLARE
        r record;
	requestTitle TEXT;
