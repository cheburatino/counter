...
BEGIN
    ...
    if (params ->> 'id')::int = -1 then
        ...
        EXECUTE ('INSERT INTO invoice (title, total_amount, state, technical_task_id, date_plan_paid, date_transfer, date_paid, options) VALUES ($1, $2, $3, $4, $5, $6, $7, $8)  RETURNING *;')
		INTO invoiceRow
		USING
			(params ->> 'title')::text,
