-- функция триггер
DROP FUNCTION IF EXISTS ctlg_request_priority_trigger_before() CASCADE;
CREATE OR REPLACE FUNCTION ctlg_request_priority_trigger_before() RETURNS trigger AS
$$
DECLARE
        r record;
