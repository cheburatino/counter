-- функция триггер
DROP FUNCTION IF EXISTS ctlg_task_status_type_trigger_before() CASCADE;
CREATE OR REPLACE FUNCTION ctlg_task_status_type_trigger_before() RETURNS trigger AS
$$
DECLARE
        r record;
