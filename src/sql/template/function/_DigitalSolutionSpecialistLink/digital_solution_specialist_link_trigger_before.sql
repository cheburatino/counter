...
BEGIN
        ...
        NEW.options = coalesce(OLD.options, '{}'::jsonb) || NEW.options || jsonb_build_object('title', jsonb_build_object('digital_solution_title', digitalSolutionTitle, 'specialist_title', specialistTitle, 'role_title', roleTitle, 'author_title', authorTitle));
        -- заполняем search_text
        
        NEW.search_text = concat(digitalSolutionTitle, ' ', specialistTitle, ' ', roleTitle, ' ', authorTitle, ' ', searchTxtVar);
