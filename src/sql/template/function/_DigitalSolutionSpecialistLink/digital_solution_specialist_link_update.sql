...
BEGIN
    ...
    if (params ->> 'id')::int = -1 then
        ...
        EXECUTE ('INSERT INTO digital_solution_specialist_link (title, digital_solution_id, specialist_id, role_id, description, author_id, options) VALUES ($1, $2, $3, $4, $5, $6, $7)  RETURNING *;')
