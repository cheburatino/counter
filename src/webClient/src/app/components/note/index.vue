<template>
  <q-page :padding="!isOpenInDialog">
    <comp-breadcrumb v-if="!isOpenInDialog" :list="[{label:'Заметки', docType:'note'}]"/>

    <comp-doc-list ref="docList" listTitle='Заметки' listDeletedTitle='Удаленные заметки' pg-method="note_list"
