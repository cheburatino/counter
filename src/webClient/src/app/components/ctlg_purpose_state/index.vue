<template>
  <q-page :padding="!isOpenInDialog">
    <comp-breadcrumb v-if="!isOpenInDialog" :list="[{label:'Статусы целей', docType:'ctlg_purpose_state'}]"/>

    <comp-doc-list ref="docList" listTitle='Статусы целей' listDeletedTitle='Удаленные статусы целей' pg-method="ctlg_purpose_state_list"
      ...
      <template #listItem="{item}">
        ...
        <q-item-section top side>
          <comp-item-dropdown-btn :item="item" itemProp="title" :is-edit="true" :is-delete="!(false || false)" fkProp=""
                                  pg-method="ctlg_purpose_state_update"
