  ...
  <q-page padding>
    ...
    <div v-if="item" class="q-mt-sm">
      ...
      <div class="col-md-2 col-sm-3 col-xs-6">
          <comp-fld-ref-search outlined pgMethod="sprint_list" :label="$t('functional_requirement.sprint_id')" :item='item.sprint_title' :itemId='item.sprint_id' :ext='{}' @update="v=> item.sprint_id = v.id" @clear="item.sprint_id = null" :readonly='false'  class='q-mb-sm col-md-2 col-sm-3 col-xs-6' />
      </div>
