...
<template>
  <q-page :padding="!isOpenInDialog">
    <comp-breadcrumb v-if="!isOpenInDialog" :list="[{label:'Типы статусов', docType:'ctlg_status_type'}]"/>

    <comp-doc-list ref="docList" listTitle='Типы статусов' listDeletedTitle='Удаленные типы статусов' pg-method="ctlg_status_type_list"
      ...
      <template #listItem="{item}">
        ...
        <q-item-section top side>
          <comp-item-dropdown-btn :item="item" itemProp="title" :is-edit="true" :is-delete="!(false || false)" fkProp=""
                                  pg-method="ctlg_status_type_update"
