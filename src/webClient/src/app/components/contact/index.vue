...
<template>
  <q-page :padding="!isOpenInDialog">
    <comp-breadcrumb class="text-capitalize" v-if="!isOpenInDialog" :list="[{label: $t('contact.name_plural'), docType:'contact'}]"/>

    <comp-doc-list ref="docList" :listTitle="$t('contact.name_plural')" :listDeletedTitle="$t('contact.name_plural_deleted')" pg-method="contact_list"
