<template>
  <q-page :padding="!isOpenInDialog">
    <comp-breadcrumb v-if="!isOpenInDialog" :list="[{label:'Системы', docType:'system'}]"/>

    <comp-doc-list ref="docList" listTitle='Системы' listDeletedTitle='Удаленные системы' pg-method="system_list"
