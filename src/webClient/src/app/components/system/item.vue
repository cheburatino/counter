...
<script>
    ...
    export default {
        ...
        components: {bugListRefListWidget, compExecutor, compCustomer, compCustomerAgent, compRelation, taskListRefListWidget, customerTaskListRefListWidget, digitalSolutionListRefListWidget, requestListRefListWidget, ftListRefListWidget},
