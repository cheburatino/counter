...
<script>
    ...
    export default {
        ...
        components: {taskListRefListWidget, requestListRefListWidget, ftListRefListWidget, bugListRefListWidget, compExecutor, compRelation, customerTaskListRefListWidget, digitalSolutionListRefListWidget, compCustomer, compCustomerAgent},
