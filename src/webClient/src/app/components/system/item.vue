...
<script>
    ...
    export default {
        ...
        components: {taskListRefListWidget, ftListRefListWidget, compExecutor, compCustomer, compCustomerAgent, compRelation, customerTaskListRefListWidget, requestListRefListWidget, digitalSolutionListRefListWidget, bugListRefListWidget},
