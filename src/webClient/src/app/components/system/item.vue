...
<script>
    ...
    export default {
        ...
        components: {customerTaskListRefListWidget, requestListRefListWidget, ftListRefListWidget, bugListRefListWidget, compExecutor, compCustomerAgent, compRelation, taskListRefListWidget, digitalSolutionListRefListWidget, compCustomer},
