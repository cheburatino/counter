...
<script>
    ...
    export default {
        ...
        components: {compRelation, taskListRefListWidget, customerTaskListRefListWidget, requestListRefListWidget, digitalSolutionListRefListWidget, bugListRefListWidget, compExecutor, compCustomer, compCustomerAgent, ftListRefListWidget},
