...
<script>
    ...
    export default {
        ...
        components: {compExecutor, compCustomer, compCustomerAgent, customerTaskListRefListWidget, bugListRefListWidget, compRelation, taskListRefListWidget, requestListRefListWidget, ftListRefListWidget, digitalSolutionListRefListWidget},
