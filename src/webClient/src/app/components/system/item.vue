...
<script>
    ...
    export default {
        ...
        components: {compCustomerAgent, compRelation, taskListRefListWidget, ftListRefListWidget, bugListRefListWidget, compExecutor, compCustomer, customerTaskListRefListWidget, requestListRefListWidget, digitalSolutionListRefListWidget},
