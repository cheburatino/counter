...
<script>
    ...
    export default {
        ...
        components: {taskListRefListWidget, customerTaskListRefListWidget, requestListRefListWidget, ftListRefListWidget, digitalSolutionListRefListWidget, bugListRefListWidget, compExecutor, compCustomer, compCustomerAgent, compRelation},
