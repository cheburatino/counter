...
<script>
    ...
    export default {
        ...
        components: {compCustomer, compCustomerAgent, customerTaskListRefListWidget, requestListRefListWidget, bugListRefListWidget, compExecutor, compRelation, taskListRefListWidget, ftListRefListWidget, digitalSolutionListRefListWidget},
