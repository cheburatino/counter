...
<script>
    ...
    export default {
        ...
        components: {compCustomer, compRelation, customerTaskListRefListWidget, ftListRefListWidget, digitalSolutionListRefListWidget, compExecutor, compCustomerAgent, taskListRefListWidget, requestListRefListWidget, bugListRefListWidget},
