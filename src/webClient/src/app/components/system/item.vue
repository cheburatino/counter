...
<script>
    ...
    export default {
        ...
        components: {compExecutor, compCustomer, compCustomerAgent, compRelation, digitalSolutionListRefListWidget, bugListRefListWidget, taskListRefListWidget, customerTaskListRefListWidget, requestListRefListWidget, ftListRefListWidget},
