...
<script>
    ...
    export default {
        ...
        components: {compRelation, taskListRefListWidget, customerTaskListRefListWidget, requestListRefListWidget, ftListRefListWidget, bugListRefListWidget, compExecutor, compCustomer, compCustomerAgent, digitalSolutionListRefListWidget},
