...
<script>
    ...
    export default {
        ...
        components: {compCustomer, compCustomerAgent, compRelation, requestListRefListWidget, digitalSolutionListRefListWidget, compExecutor, customerTaskListRefListWidget, ftListRefListWidget, bugListRefListWidget, taskListRefListWidget},
