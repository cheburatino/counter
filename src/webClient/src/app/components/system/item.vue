...
<script>
    ...
    export default {
        ...
        components: {compExecutor, compCustomer, compCustomerAgent, compRelation, taskListRefListWidget, digitalSolutionListRefListWidget, bugListRefListWidget, customerTaskListRefListWidget, requestListRefListWidget, ftListRefListWidget},
