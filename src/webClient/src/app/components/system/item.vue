...
<script>
    ...
    export default {
        ...
        components: {ftListRefListWidget, digitalSolutionListRefListWidget, compCustomer, taskListRefListWidget, customerTaskListRefListWidget, requestListRefListWidget, compExecutor, compCustomerAgent, compRelation, bugListRefListWidget},
