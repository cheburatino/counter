    ...
    export default {
        ...
        methods: {
            ...
            reload(isDeleted) {
                ...
                this.$utils.callPgMethod('completion_act_list', {'technical_task_id': this.id, deleted: this.deleted, 'order_by': 'created_at desc', }, (result) => this.list = result)
            },
            saveNew() {
                ...
                // если IsStateMachine то completion_act_create, в остальных случаях completion_act_update
                this.$utils.callPgMethod('completion_act_update', params, () => {
            ...
            removeRecover({id}) {
                this.$utils.callPgMethod('completion_act_update', {id, deleted: !this.deleted}, () => this.reload(this.deleted))
            }
        },
        mounted() {
            this.reload()
