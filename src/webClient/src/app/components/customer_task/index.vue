...
<template>
  <q-page :padding="!isOpenInDialog">
    <comp-breadcrumb class="text-capitalize" v-if="!isOpenInDialog" :list="[{label: $t('customer_task.name_plural'), docType:'customer_task'}]"/>

    <comp-doc-list ref="docList" :listTitle="$t('customer_task.name_plural')" :listDeletedTitle="$t('customer_task.name_plural_deleted')" pg-method="customer_task_list"
      ...
      <template #listItem="{item}">
        ...
        <q-item-section top side>
          <comp-item-dropdown-btn :item="item" itemProp="title" :is-edit="true" :is-delete="!(false || false)" fkProp=""
                                  pg-method="customer_task_update"
  ...
  export default {
    ...
    methods: {
      ...
      updateFilterCtlgTaskState(v) {
        ...
        if (v) {
          this.$utils.callPgMethod(`ctlg_development_task_state_get_by_id`, {id: v.id}, (res) => {
