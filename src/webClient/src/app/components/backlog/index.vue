<template>
  <q-page :padding="!isOpenInDialog">
    <comp-breadcrumb v-if="!isOpenInDialog" :list="[{label:'Бэклоги', docType:'backlog'}]"/>

    <comp-doc-list ref="docList" listTitle='Бэклоги' listDeletedTitle='Удаленные бэклоги' pg-method="backlog_list"
