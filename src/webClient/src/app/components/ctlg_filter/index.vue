...
<template>
  <q-page :padding="!isOpenInDialog">
    <comp-breadcrumb class="text-capitalize" v-if="!isOpenInDialog" :list="[{label: $t('ctlg_filter.name_plural'), docType:'ctlg_filter'}]"/>

    <comp-doc-list ref="docList" :listTitle="$t('ctlg_filter.name_plural')" :listDeletedTitle="$t('ctlg_filter.name_plural_deleted')" pg-method="ctlg_filter_list"
