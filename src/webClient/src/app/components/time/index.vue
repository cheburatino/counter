<template>
  <q-page :padding="!isOpenInDialog">
    <comp-breadcrumb v-if="!isOpenInDialog" :list="[{label:'Время', docType:'time'}]"/>

    <comp-doc-list ref="docList" listTitle='Время' listDeletedTitle='Удаленные время' pg-method="time_list"
