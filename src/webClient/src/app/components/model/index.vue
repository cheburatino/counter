...
<template>
  <q-page :padding="!isOpenInDialog">
    <comp-breadcrumb class="text-capitalize" v-if="!isOpenInDialog" :list="[{label: $t('model.name_plural'), docType:'model'}]"/>

    <comp-doc-list ref="docList" :listTitle="$t('model.name_plural')" :listDeletedTitle="$t('model.name_plural_deleted')" pg-method="model_list"
