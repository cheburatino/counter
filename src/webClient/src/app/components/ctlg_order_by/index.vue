...
<template>
  <q-page :padding="!isOpenInDialog">
    <comp-breadcrumb class="text-capitalize" v-if="!isOpenInDialog" :list="[{label: $t('ctlg_order_by.name_plural'), docType:'ctlg_order_by'}]"/>

    <comp-doc-list ref="docList" :listTitle="$t('ctlg_order_by.name_plural')" :listDeletedTitle="$t('ctlg_order_by.name_plural_deleted')" pg-method="ctlg_order_by_list"
      ...
      <template #listItem="{item}">
        ...
        <q-item-section top side>
          <comp-item-dropdown-btn :item="item" itemProp="title" :is-edit="true" :is-delete="!(false || false)" fkProp=""
                                  pg-method="ctlg_order_by_update"
