...
<template>
  <q-page :padding="!isOpenInDialog">
    <comp-breadcrumb v-if="!isOpenInDialog" :list="[{label:'Компетенции', docType:'electron_skill'}]"/>

    <comp-doc-list ref="docList" listTitle='Компетенции' listDeletedTitle='Удаленные компетенции' pg-method="electron_skill_list"
      ...
      <template #listItem="{item}">
        ...
        <q-item-section top side>
          <comp-item-dropdown-btn :item="item" itemProp="title" :is-edit="true" :is-delete="!(false || false)" fkProp=""
                                  pg-method="electron_skill_update"
