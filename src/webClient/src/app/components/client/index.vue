<template>
  <q-page :padding="!isOpenInDialog">
    <comp-breadcrumb v-if="!isOpenInDialog" :list="[{label:'Клиенты', docType:'client'}]"/>

    <comp-doc-list ref="docList" listTitle='Клиенты' listDeletedTitle='Удаленные клиенты' pg-method="client_list"
