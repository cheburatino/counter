<template>
  <q-page padding>
    ...
    <div v-if="item" class="q-mt-sm">
      ...
      <div class="col-md-4 col-xs-6">
          <q-select outlined label="статус" v-model='item.status' :options='[{"label":"в работе","value":"in_work","color":""},{"label":"завершена","value":"completed","color":""}]'   :readonly='false'  class='q-mb-sm col-md-4 col-xs-6' />
      </div>
      </div>
      ...
      <div class="col-md-4 col-xs-6">
          <comp-fld-ref-search outlined pgMethod="user_list" label="постановщик" :item='item.director_title' :itemId='item.director_id' :ext='{}' @update="v=> item.director_id = v.id" @clear="item.director_id = null" :readonly='false'  class='q-mb-sm col-md-4 col-xs-6' />
      </div>
      </div>
      
      <div class="row q-col-gutter-md q-mb-sm">
      <div class="col-md-4 col-xs-6">
          <comp-fld-ref-search outlined pgMethod="user_list" label="исполнитель" :item='item.executor_title' :itemId='item.executor_id' :ext='{}' @update="v=> item.executor_id = v.id" @clear="item.executor_id = null" :readonly='false'  class='q-mb-sm col-md-4 col-xs-6' />
      </div>
      <div class="col-md-4 col-xs-6">
      ...
      <div class="row q-col-gutter-md q-mb-sm">
      <div class="col-md-4 col-xs-6">
          <comp-fld-date outlined label="плановая дата начала" :date-string="$utils.formatPgDate(item.plan_start_date)" @update="v=> item.plan_start_date = v" :readonly='false'  class='q-mb-sm col-md-4 col-xs-6' />
      </div>
      <div class="col-md-4 col-xs-6">
          <comp-fld-date outlined label="фактическая дата начала" :date-string="$utils.formatPgDate(item.fact_start_date)" @update="v=> item.fact_start_date = v" :readonly='false'  class='q-mb-sm col-md-4 col-xs-6' />
      </div>
      </div>
      
      <div class="row q-col-gutter-md q-mb-sm">
      <div class="col-md-4 col-xs-6">
          <comp-fld-date outlined label="плановая дата завершения" :date-string="$utils.formatPgDate(item.plan_end_date)" @update="v=> item.plan_end_date = v" :readonly='false'  class='q-mb-sm col-md-4 col-xs-6' />
      </div>
      <div class="col-md-4 col-xs-6">
          <comp-fld-date outlined label="фактическая дата завершения" :date-string="$utils.formatPgDate(item.fact_end_date)" @update="v=> item.fact_end_date = v" :readonly='false'  class='q-mb-sm col-md-4 col-xs-6' />
      </div>
      </div>
      ...
      <div class="col-md-4 col-xs-6">
          <comp-fld-ref-search outlined pgMethod="project_list" label="проект" :item='item.project_title' :itemId='item.project_id' :ext='{}' @update="v=> item.project_id = v.id" @clear="item.project_id = null" :readonly='false'  class='q-mb-sm col-md-4 col-xs-6' />
      </div>
      </div>
