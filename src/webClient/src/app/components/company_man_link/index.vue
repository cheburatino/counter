...
<template>
  <q-page :padding="!isOpenInDialog">
    <comp-breadcrumb class="text-capitalize" v-if="!isOpenInDialog" :list="[{label: $t('company_man_link.name_plural'), docType:'company_man_link'}]"/>

    <comp-doc-list ref="docList" :listTitle="$t('company_man_link.name_plural')" :listDeletedTitle="$t('company_man_link.name_plural_deleted')" pg-method="company_man_link_list"
      ...
      <template #listItem="{item}">
        ...
        <q-item-section top side>
          <comp-item-dropdown-btn :item="item" itemProp="title" :is-edit="true" :is-delete="!(false || false)" fkProp=""
                                  pg-method="company_man_link_update"
