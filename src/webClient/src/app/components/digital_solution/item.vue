...
<script>
    ...
    export default {
        ...
        components: {compSpecialist, compCustomerAgent, compRealization, compResult, taskListRefListWidget, bugListRefListWidget, compExecutor, compRelation, compModeling, customerTaskListRefListWidget, ftListRefListWidget, compCustomer},
