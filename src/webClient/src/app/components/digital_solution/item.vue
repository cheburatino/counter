...
<script>
    ...
    export default {
        ...
        components: {compModeling, compRealization, taskListRefListWidget, ftListRefListWidget, compCustomerAgent, compCustomer, compRelation, compSpecialist, compResult, customerTaskListRefListWidget, bugListRefListWidget, compExecutor},
