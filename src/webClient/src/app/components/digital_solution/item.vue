...
<script>
    ...
    export default {
        ...
        components: {compSpecialist, compModeling, compRealization, compResult, taskListRefListWidget, customerTaskListRefListWidget, compExecutor, compRelation, ftListRefListWidget, bugListRefListWidget, compCustomer, compCustomerAgent},
