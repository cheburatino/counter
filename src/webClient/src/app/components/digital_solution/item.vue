...
<script>
    ...
    export default {
        ...
        components: {ftListRefListWidget, compCustomer, compRelation, compCustomerAgent, compModeling, compRealization, compResult, taskListRefListWidget, compExecutor, compSpecialist, customerTaskListRefListWidget, bugListRefListWidget},
