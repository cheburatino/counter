...
<script>
    ...
    export default {
        ...
        components: {ftListRefListWidget, taskListRefListWidget, customerTaskListRefListWidget, compParticipants, compModeling, compRealization, compSpecialist, compCustomerAgent},
