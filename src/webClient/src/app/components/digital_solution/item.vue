...
<script>
    ...
    export default {
        ...
        components: {compRelation, compSpecialist, compCustomerAgent, compModeling, compRealization, compResult, taskListRefListWidget, compExecutor, bugListRefListWidget, ftListRefListWidget, customerTaskListRefListWidget, compCustomer},
