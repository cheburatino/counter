...
<script>
    ...
    export default {
        ...
        components: {compExecutor, compCustomerAgent, compRealization, customerTaskListRefListWidget, compResult, taskListRefListWidget, ftListRefListWidget, bugListRefListWidget, compCustomer, compRelation, compSpecialist, compModeling},
