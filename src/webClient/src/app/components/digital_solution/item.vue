...
<script>
    ...
    export default {
        ...
        components: {compCustomerAgent, ftListRefListWidget, taskListRefListWidget, customerTaskListRefListWidget, compParticipants, compModeling, compRealization, compSpecialist},
