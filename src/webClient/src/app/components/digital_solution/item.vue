...
<script>
    ...
    export default {
        ...
        components: {compResult, taskListRefListWidget, customerTaskListRefListWidget, ftListRefListWidget, bugListRefListWidget, compRealization, compExecutor, compCustomer, compRelation, compSpecialist, compCustomerAgent, compModeling},
