...
<script>
    ...
    export default {
        ...
        components: {compParticipants, compModeling, compRealization, compSpecialist, compCustomerAgent, ftListRefListWidget, taskListRefListWidget, customerTaskListRefListWidget},
