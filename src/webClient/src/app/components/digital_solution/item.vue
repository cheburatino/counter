...
<script>
    ...
    export default {
        ...
        components: {ftListRefListWidget, compCustomer, compRelation, customerTaskListRefListWidget, compModeling, compRealization, compResult, taskListRefListWidget, bugListRefListWidget, compExecutor, compSpecialist, compCustomerAgent},
