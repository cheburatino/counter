...
<script>
    ...
    export default {
        ...
        components: {customerTaskListRefListWidget, compExecutor, compRelation, compSpecialist, compCustomerAgent, compRealization, compResult, compCustomer, compModeling, taskListRefListWidget, ftListRefListWidget, bugListRefListWidget},
