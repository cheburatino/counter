...
<script>
    ...
    export default {
        ...
        components: {compModeling, taskListRefListWidget, ftListRefListWidget, bugListRefListWidget, compCustomerAgent, compRealization, compResult, customerTaskListRefListWidget, compExecutor, compCustomer, compRelation, compSpecialist},
