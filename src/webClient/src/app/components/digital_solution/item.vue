...
<script>
    ...
    export default {
        ...
        components: {compExecutor, compModeling, customerTaskListRefListWidget, bugListRefListWidget, compRealization, compResult, taskListRefListWidget, ftListRefListWidget, compCustomer, compRelation, compSpecialist, compCustomerAgent},
