...
<script>
    ...
    export default {
        ...
        components: {compCustomerAgent, compRealization, compResult, bugListRefListWidget, customerTaskListRefListWidget, ftListRefListWidget, compExecutor, compCustomer, compRelation, compSpecialist, compModeling, taskListRefListWidget},
