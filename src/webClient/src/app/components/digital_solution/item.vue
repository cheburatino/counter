...
<script>
    ...
    export default {
        ...
        components: {compExecutor, compCustomer, compModeling, compResult, ftListRefListWidget, bugListRefListWidget, compRelation, compSpecialist, compCustomerAgent, compRealization, taskListRefListWidget, customerTaskListRefListWidget},
