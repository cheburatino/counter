...
<script>
    ...
    export default {
        ...
        components: {compSpecialist, compRealization, customerTaskListRefListWidget, bugListRefListWidget, compModeling, compResult, taskListRefListWidget, ftListRefListWidget, compExecutor, compCustomer, compRelation, compCustomerAgent},
