...
<script>
    ...
    export default {
        ...
        components: {compCustomerAgent, compRealization, ftListRefListWidget, bugListRefListWidget, compExecutor, compCustomer, compRelation, compSpecialist, compModeling, compResult, taskListRefListWidget, customerTaskListRefListWidget},
