...
<script>
    ...
    export default {
        ...
        components: {compCustomerAgent, compRealization, customerTaskListRefListWidget, ftListRefListWidget, compModeling, compResult, taskListRefListWidget, bugListRefListWidget, compExecutor, compCustomer, compRelation, compSpecialist},
