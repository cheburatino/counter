...
<script>
    ...
    export default {
        ...
        components: {customerTaskListRefListWidget, compParticipants, compModeling, compRealization, compSpecialist, compCustomerAgent, ftListRefListWidget, taskListRefListWidget},
