...
<script>
    ...
    export default {
        ...
        components: {compResult, taskListRefListWidget, customerTaskListRefListWidget, compCustomer, compRelation, compCustomerAgent, compRealization, ftListRefListWidget, bugListRefListWidget, compExecutor, compSpecialist, compModeling},
