<template>
  <q-page padding>
    ...
    <comp-breadcrumb v-if="!isOpenInDialog" :list="[{label:'Сотрудники', to:'/employee',  docType: 'employee'},  {label: item ? (item.title ? item.title : 'Редактирование') : '',  docType: 'edit'}]"/>
    ...
    export default {
        ...
        methods: {
          ...
          reload() {
            ...
            this.$utils.getDocItemById.call(this, {method: 'employee_get_by_id', cb})
          }
        },
        mounted() {
           this.reload()
