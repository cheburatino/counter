<template>
  <q-page padding>
    ...
    <div v-if="item" class="q-mt-sm">
      ...
      <div class="col-md-4 col-sm-6 col-xs-12">
          <comp-fld-ref-search outlined pgMethod="man_list" :label="$t('task.director_id')" :item='item.director_title' :itemId='item.director_id' :ext='{company_id: 1, isClearable: "true", pathUrl: "/man", avatar: "image/man.svg"}' @update="v=> item.director_id = v.id" @clear="item.director_id = null" :readonly='false'  class='q-mb-sm col-md-4 col-sm-6 col-xs-12' />
      </div>
      </div>
