<template>
  <q-page :padding="!isOpenInDialog">
    <comp-breadcrumb v-if="!isOpenInDialog" :list="[{label:'Цели', docType:'purpose'}]"/>

    <comp-doc-list ref="docList" listTitle='Цели' listDeletedTitle='Удаленные цели' pg-method="purpose_list"
