...
<script>
    ...
    export default {
        ...
        components: {customerTaskListRefListWidget, ftListRefListWidget, compCustomerAgent, compRelation, compExecutor, compCustomer, compResult, taskListRefListWidget},
