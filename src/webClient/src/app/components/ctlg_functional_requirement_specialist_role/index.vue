...
<template>
  <q-page :padding="!isOpenInDialog">
    <comp-breadcrumb class="text-capitalize" v-if="!isOpenInDialog" :list="[{label: $t('ctlg_functional_requirement_specialist_role.name_plural'), docType:'ctlg_functional_requirement_specialist_role'}]"/>

    <comp-doc-list ref="docList" :listTitle="$t('ctlg_functional_requirement_specialist_role.name_plural')" :listDeletedTitle="$t('ctlg_functional_requirement_specialist_role.name_plural_deleted')" pg-method="ctlg_functional_requirement_specialist_role_list"
      ...
      <template #listItem="{item}">
        ...
        <q-item-section top side>
          <comp-item-dropdown-btn :item="item" itemProp="title" :is-edit="true" :is-delete="!(false || false)" fkProp=""
                                  pg-method="ctlg_functional_requirement_specialist_role_update"
...
<script>
  ...
  export default {
    ...
    computed: {
      currentUrl: () => '/ctlg_functional_requirement_specialist_role/',
    },
    data() {
      return {
        listSortData: [
