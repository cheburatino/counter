const routes = [
  ...
  // for codeGenerate ##routes_slot1
	...
	{path: '/ctlg_task_status_type', component: () => import(`../app/components/ctlg_task_status_type/index.vue`), props: true},
	{path: '/ctlg_task_status_type/:id', component: () => import(`../app/components/ctlg_task_status_type/item.vue`), props: true},
	{path: '/ctlg_subtask_state', component: () => import(`../app/components/ctlg_subtask_state/index.vue`), props: true},
	{path: '/ctlg_subtask_state/:id', component: () => import(`../app/components/ctlg_subtask_state/item.vue`), props: true},
