...
const (
	name            = "bug_customer_agent_link"
	name_ru         = "связь бага и представителя заказчика"
	name_ru_plural  = "связи багов и представителей заказчиков"
