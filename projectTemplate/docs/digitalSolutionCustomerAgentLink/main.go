package digitalSolutionCustomerAgentLink
...
const (
	name            = "digital_solution_customer_agent_link"
	name_ru         = "связь цифрового решения и заказчика"
	name_ru_plural  = "связи цифровых решений и заказчиков"
