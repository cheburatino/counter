...
func GetDoc(project *t.ProjectType) t.DocType {
	doc := t.DocType{
		...
		Flds: []t.FldType{
			...
			t.GetFldDate("date_plan_paid", "планируемая дата оплаты", [][]int{{3, 1}}, "col-2"),
			t.GetFldDate("date_transfer", "дата выставления", [][]int{{3, 2}}, "col-2"),
			t.GetFldDate("date_paid", "дата оплаты", [][]int{{3, 3}}, "col-2"),
		},
		Vue: t.DocVue{
			RouteName:      name,
			MenuIcon:       menu_icon,
