package systemCustomerAgentLink
...
const (
	name            = "system_customer_agent_link"
	name_ru         = "связь системы и представителя заказчика"
	name_ru_plural  = "связи систем и представителей заказчиков"
...
func GetDoc(project *t.ProjectType) t.DocType {
	doc := t.DocType{
		...
		PathPrefix: "docs",
		Flds: []t.FldType{
			t.GetFldRef("system_id", "система", "system", [][]int{{2, 1}}),
