...
func GetDoc(project *t.ProjectType) t.DocType {
	doc := t.DocType{
		...
		Flds: []t.FldType{
			...
			t.GetFldRef("development_task_id", "задача на разработку", "development_task", [][]int{{2, 3}}, "col-2", "isShowLink", "isClearable"),
			t.GetFldRef("type_id", "тип задачи", "ctlg_task_type", [][]int{{3, 1}}, "col-2"),
			...
			t.GetFldRef("executor_id", "исполнитель", "man", [][]int{{4, 1}}, "col-2", "isShowLink", "isClearable"),
