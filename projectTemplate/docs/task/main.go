...
func GetDoc(project *t.ProjectType) t.DocType {
	doc := t.DocType{
		...
		Flds: []t.FldType{
			...
			t.GetFldRef("model_id", "модель", "model", [][]int{{3, 1}}, "col-3", "isShowLink", "isClearable"),
			t.GetFldRef("functional_requirement_id", "функциональное требование", "functional_requirement", [][]int{{3, 2}}, "col-3", "isShowLink", "isClearable"),
			t.GetFldRef("bug_id", "баг", "bug", [][]int{{3, 3}}, "col-2", "isShowLink", "isClearable"),
