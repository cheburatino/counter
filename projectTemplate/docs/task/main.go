...
func GetDoc(project *t.ProjectType) t.DocType {
	doc := t.DocType{
		...
		Flds: []t.FldType{
			...
			t.GetFldCheckbox("needs_discusion", "требует обсуждения", [][]int{{1, 3}}, "col-1").SetDefault("false"),
			t.GetFldRef("state_id", "статус", "ctlg_task_state", [][]int{{1, 4}}, "col-1").SetDefault("1"),
			t.GetFldRef("system_id", "система", "system", [][]int{{2, 1}}, "col-4", "isShowLink", "isClearable"),
			t.GetFldRef("digital_solution_id", "цифровое решение", "digital_solution", [][]int{{2, 2}}, "col-4", "isShowLink", "isClearable"),
			t.GetFldRef("executor_id", "исполнитель", "man", [][]int{{3, 1}}, "col-2", "isShowLink", "isClearable"),
			t.GetFldRef("model_id", "модель", "model", [][]int{{3, 2}}, "col-2", "isShowLink", "isClearable"),
			t.GetFldRef("functional_requirement_id", "функциональное требование", "functional_requirement", [][]int{{3, 3}}, "col-2", "isShowLink", "isClearable"),
			t.GetFldRef("bug_id", "баг", "bug", [][]int{{3, 4}}, "col-2", "isShowLink", "isClearable"),
			t.GetFldRef("sprint_id", "спринт", "sprint", [][]int{{4, 1}}, "col-2", "isShowLink", "isClearable"),
			t.GetFldInt("estimate", "оценка", [][]int{{4, 2}}, "col-1"),
			t.GetFldInt("worked_time", "затрачено", [][]int{{4, 3}}, "col-1"),
			t.GetFldDate("plan_end_date", "плановая дата завершения", [][]int{{4, 4}}, "col-2"),
			t.GetFldDate("fact_end_date", "фактическая дата завершения", [][]int{{4, 5}}, "col-2"),
			t.GetFldString("description", "описание", 0, [][]int{{5, 1}}, "col-8"),
			t.GetFldFiles("files", "файлы", [][]int{{6, 1}}, t.FldVueFilesParams{}),
			t.GetFldImgList("images", "изображения", [][]int{{6, 2}}, t.FldVueImgParams{}),
			t.GetFldString("process", "процесс", 0, [][]int{{7, 1}}, "col-8"),
			t.GetFldFiles("process_files", "файлы результата", [][]int{{8, 1}}, t.FldVueFilesParams{}),
			t.GetFldImgList("process_images", "изображения результата", [][]int{{8, 2}}, t.FldVueImgParams{}),
