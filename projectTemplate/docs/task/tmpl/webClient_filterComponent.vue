  ...
  setup(props, {emit}) {
    ...
    const editFilter = () => {
        $utils.postCallPgMethod({
          ...
          params: {
            id: curFilter.value.id,
            title: editFilterTitle.value,
            index: 'task',
            where_str: editFilterCondition.value,
            user_table_id: props.currentUser.id,
            is_default: defCheckbox.value
          }
        }).subscribe(v => {
    ...
    const editOrder = () => {
        $utils.postCallPgMethod({
          ...
          params: {
            id: curOrder.value.id,
            title: editOrderTitle.value,
            index: 'task',
            order_by_str: editOrderCondition.value,
            user_table_id: props.currentUser.id,
            is_default: defCheckboxOrder.value
          }
        }).subscribe(v => {
