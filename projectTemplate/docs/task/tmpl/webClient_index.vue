      ...
      <template #listItem="{item}">
		...
		<router-link :to="currentUrl + item.id" style="cursor: pointer">
           ...
           <q-item-label caption>
             <q-badge v-if="item.specialist_priority" class="q-ma-xs" color="warning">{{item.specialist_priority}}</q-badge>
             <q-badge class="q-ma-xs" color="orange">{{item.options.title.state_title}}</q-badge>
             <q-badge v-if="item.today" class="q-ma-xs" color="positive">На сегодня</q-badge>
