package requestCustomerAgentLink
...
const (
	name            = "request_customer_agent_link"
	name_ru         = "связь запроса и представителя заказчика"
	name_ru_plural  = "связи запросов и представителей заказчиков"
